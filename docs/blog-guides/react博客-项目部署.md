...
out_dated: true
summary: |-
  1. 最近阿里云推出“在家实践活动”，可以免费领取半年的服务器。
  2. 购买服务器后，使用 Putty 连接服务器，并安装宝塔进行管理。
  3. 通过宝塔安装必要的软件，如 PHP 环境、phpMyAdmin、PM2 和 nginx。
  4. 开放 80 端口，以便可以通过公网 IP 访问服务器。
  5. 将项目代码克隆到服务器，并打包部署项目。
---
