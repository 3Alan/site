...
wip: true
summary: >-
  最近对移动端开发很感兴趣，之前使用过 React Native 开发，发现 Expo 是一个非常不错的框架，可以帮助 Web 开发人员轻松开发移动端应用。


  这篇文章记录了我在开发 Airbnb Clone 项目时遇到的问题和解决方案，包括 Expo 的特性、RN 生态、RN 开发和 Web
  开发的区别、手机状态栏高度的处理、RN 中不支持的一些 Web 特性、Prisma、React Query 以及一些错误。


  在 RN 中，文本节点必须包裹在 Text 组件中，样式是通过 style 属性传递给组件的，默认使用 Flex 布局。
---
