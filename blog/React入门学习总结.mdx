...
authors: Alan
summary: >-
  React 入门教程，涵盖了 React 的常见生态，包括基础知识点、组件通信、props 参数校验及默认值、异步组件加载插件、虚拟
  DOM、生命周期、性能优化、Redux、Redux-thunk、Redux-saga、React-redux、CSS
  写法、React-router、React vs Vue 等内容。
