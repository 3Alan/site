...
summary: >-
  ...
  的基础上增加了可选的**静态类型**和基于类的面向对象编程。它可以编译成纯 JavaScript，未编译的 ts 代码无法在浏览器执行。我们把它和
  JavaScript 的关系理解成 css 和 less、sass 的关系。


  TypeScript 常用知识点总结：


  - 基础类型：boolean、number、string、数组、元组、枚举、any、void、null、undefined、never
