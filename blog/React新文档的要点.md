...
draft: true
summary: >-
  React 新文档强调了不可变性的重要性，并建议在组件中使用纯函数来保持组件的纯净性。同时，文档还介绍了如何使用 use-immer
  来解决嵌套对象书写问题。此外，文档还提供了有关命名风格、hook 原理、setState 命名风格、队列状态更新、通过改变 key 值来重新渲染、声明式
  UI 的 state 设计以及避免深度嵌套状态等方面的建议。
---
