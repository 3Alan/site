...
sidebar_position: 2
summary: >-
  Webpack loader 的基本使用包括 file-loader、url-loader、css-loader 和
  style-loader。file-loader 可以打包图片文件，url-loader 可以将图片转化为 base64 编码，css-loader 和
  style-loader 可以打包 CSS 文件。css-loader 的 options 中的 importLoaders 可以控制处理 @import
  引入的 CSS 文件的 loader 数量。file-loader 可以处理字体文件。
---
