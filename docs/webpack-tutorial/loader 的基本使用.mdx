...
sidebar_position: 2
summary: >-
  在这一节中，讲解了一些常见的 Loader 的使用，包括 file-loader、url-loader 以及 css-loader 和
  style-loader。file-loader 可以打包图片，url-loader 可以将图片转化为 base64 编码，css-loader 和
  style-loader 可以打包 CSS 文件。此外，还介绍了 css 模块化、css 外部引入和处理字体文件。
---
