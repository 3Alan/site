...
sidebar_position: 3
summary: |-
  Docusaurus 自动提交 URL 到搜索引擎的 Github Action。
  前提是网站已经生成了 sitemap。
  创建 Github Action，配置 Actions secrets，就可以自动提交 URL 到百度、必应、谷歌搜索引擎。
  如果配置了必应 token，提交 URL 的数量应小于 10，否则提交失败。
  百度、必应、谷歌每日配额数分别为 3000、10、200。
---
