...
<Admonition type="info">
  <p>
    reducers函数的返回值要是可预测，也就是说里面不能写类似new
    Date,Ajax等的不可预测结果的代码
  </p>
  <p>
...
<Admonition type="info">
  当项目越来越大时，项目中的 reducer.js 文件也会越来越臃肿，这个时候我们可以通过 redux 提供的`combineReducers`来将 reducer 拆分成不同的模块
</Admonition>
