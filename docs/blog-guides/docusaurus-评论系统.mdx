...
sidebar_position: 1
summary: |-
  1. 通过 Docusaurus Swizzling 为博客和文档添加 Giscus 评论功能。
  2. 安装所需包 `yarn add @giscus/react mitt`。
  3. 封装评论组件，解决 Docusaurus bug 导致的评论获取错误问题。
  4. Swizzling Docusaurus 内部组件，在文档和博客页面添加评论组件。
  5. 配置 Giscus，设置评论仓库、类别等信息。
  6. 完成以上步骤，即可在博客和文档底部看到评论功能。
---
