...
sidebar_position: 1
summary: >-
  作者介绍了一种在没有服务端的情况下，使用 Github 机器人来自动为博客文章生成摘要的方法。该方法利用了 Gemini API 来生成摘要，并通过
  Github Action 或 Github Bot 来将摘要插入到文档的 front matter
  中。作者还介绍了如何部署机器人，以及如何触发机器人来总结所有博文。最后，作者总结了目前使用这种方法的优缺点，并对未来的功能需求提出了设想。
---
