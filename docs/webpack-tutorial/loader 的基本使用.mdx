...
sidebar_position: 2
summary: >-
  这节课主要讲了 webpack loader 的基本使用，包括 file-loader、url-loader 以及 css-loader 和
  style-loader。


  file-loader 可以用来打包图片、字体等文件，url-loader 可以将图片转化为 base64 编码，css-loader 和
  style-loader 可以用来打包 CSS 文件。


  css-loader 还可以通过配置 options 来使用 css 的模块化，也可以通过设置 importLoaders 数目来处理 CSS 文件中的
  @import 语句。


  最后，还介绍了如何使用 file-loader 来处理字体文件。
---
