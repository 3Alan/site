...
draft: true
summary: |-
  - 小红书面试官问到自定义过 hook 吗，我回答了 `useOnClickOutSide`。
  - XTransfer 面试官问到 React diff 算法，我回答了深度优先遍历的过程和算法复杂度。
  - 黑湖面试官问到遇到的最难的问题，我回答了重构 3.0。
  - ebay 外包面试官问到线上错误的追踪，我回答了错误监控系统的设计和 source-map 及映射原理。
  - 每个面试官都问到了 hook 和 class 的区别，我回答了 hook 更加利于逻辑复用，class 要使用 HOC。
---
