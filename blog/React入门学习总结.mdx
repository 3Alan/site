...
summary: |-
  ...
  - CSS 写法：React 提供了几种 CSS 书写方式，包括 CSS in JS、styled-components 和 CSS-module。
  - React vs Vue：React 对比 Vue 来说，学习成本比较高，但是比较灵活。而 Vue 提供了很多封装好的 API，学习起来对小白比较友好。
---
