...
authors: Alan
summary: >-
  主要记录了我工作一年来遇到的一些困难以及解决方法，包括
  Vue、React、CSS、mpvue、Docker、ReactNative、puppeteer、html2canvas、移动端适配、移动端保存图片到本地、nvm
  管理多 node 版本、多仓库的问题、typescript 相关、git 回退上次的 commit、git
  文件大小写被忽略的问题、项目推送到多个仓库、node-sass 安装问题、html email、测试等方面的内容。
---
