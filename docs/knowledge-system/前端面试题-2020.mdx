...
summary: >-
  本文记录了作者疫情期间复习总结的一些面试题和面试中遇到的问题，文章将持续更新。文中主要介绍了原型及继承、深拷贝和浅拷贝、for in 和 for
  of、事件委托、实现滑动动画、eventLoop、this、闭包、Promise、防抖和节流、JS 题目、React
  生命周期、useRef、cloneElement、HOC 等内容。
---
