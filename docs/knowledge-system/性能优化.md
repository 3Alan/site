...
summary: >-
  网站加载速度对用户体验有很大影响，可以通过服务端渲染 SSR 来优化。性能监控工具可以帮助我们发现性能问题。性能指标 FCP、LCP、FID、CLS
  等可以衡量网站的性能。缓存可以减少 HTTP
  请求次数，提高网站速度。网络优化可以减少资源加载时间，提高网站速度。JS、CSS、静态资源优化可以减少资源体积，提高网站速度。SEO
  相关优化可以提高网站在搜索引擎中的排名。
---
