...
sidebar_label: 数组
summary: |-
  1. 数组去重：可以使用多种方法，如使用 Set、filter 或 indexOf。
  2. 数组填充：可以使用 fill 方法或 Array.from 方法。
  3. 数组扁平化：可以使用 flat 方法或递归的方式。
  4. 求数组最大值：可以使用 Math.max 或 sort 方法。
  5. 字符数组排序：需要考虑字符长度和字符编码。
---
