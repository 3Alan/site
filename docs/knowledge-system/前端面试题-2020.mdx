...
summary: >-
  前端面试题总结，包括 JS、前端框架相关知识点。


  JS 部分涵盖原型及继承、深拷贝和浅拷贝、for in 和 for
  of、事件委托、实现滑动动画、eventLoop、this、闭包、Promise、防抖和节流、JS 题目等。


  前端框架相关知识点包括 React 生命周期、useRef、cloneElement、HOC 等。
---
