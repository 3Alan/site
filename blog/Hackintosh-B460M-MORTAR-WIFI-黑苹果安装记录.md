...
out_dated: true
summary: >-
  黑苹果 B460M-MORTAR WIFI + i5-10400 安装记录。使用 OpenCore 引导，安装过程包括下载镜像、制作镜像 U 盘、设置
  BIOS、安装 MacOS、系统设置和将 EFI 文件移动到磁盘中。安装完成后，可以正常使用黑苹果系统，包括睡眠/唤醒、USB
  端口、核显硬件加速、声卡输出、蓝牙、wifi 等功能。
---
